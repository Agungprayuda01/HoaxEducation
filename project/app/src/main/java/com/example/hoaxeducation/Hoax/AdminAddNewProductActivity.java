...
{
    private String CategoryName, Description, Price, Pname, saveCurrentDate, saveCurrentTime,profilimage,profilname,profilemail;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        profilname = getIntent().getExtras().get("profilname").toString();
        profilimage = getIntent().getExtras().get("profilimage").toString();
        profilemail = getIntent().getExtras().get("profilemail").toString();
        ProductImagesRef = FirebaseStorage.getInstance().getReference().child("Gambar Products");
        ProductsRef = FirebaseDatabase.getInstance().getReference().child("Berita");
        ...
        InputProductPrice.setText(profilname);
    ...
    private void StoreProductInformation()
    {
        ...
        productRandomKey = saveCurrentDate + saveCurrentTime + "hoax education" + profilname;
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            {
                Toast.makeText(AdminAddNewProductActivity.this, "Berita uploaded Successfully...", Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(AdminAddNewProductActivity.this, "got the Berita image Url Successfully...", Toast.LENGTH_SHORT).show();
